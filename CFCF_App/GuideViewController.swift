...
class GuideViewController: UIViewController {
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        UIView.animate(withDuration: 1.1, delay: 0.2, options: .curveLinear, animations: {
    ...
    func fadeIn(btn1Text: String, btn2Text: String, questionLabelText: String, pulseQuestionText: Bool? = false,
        ...
        UIView.animate(withDuration: 1.1, delay: 0.7, options: .curveLinear, animations: {
    ...
    func fadeOut(btn1Text: String, btn2Text: String, questionLabelText: String, btnToChangeColor: UIButton? = nil,
        ...
        UIView.animate(withDuration: 1.1, delay: 0.7, options: .curveLinear, animations: {
            ...
            btnToChangeColor?.backgroundColor = UIColor(red:0.91, green:0.39, blue:0.38, alpha:1.0)
    ...
    @IBAction func actionBtn2(_ sender: Any) {
        if takeToLearnOrContinue {
            fadeOut(btn1Text: "", btn2Text: "", questionLabelText: "", btnToChangeColor: actionBtn2, transition: "learn")
